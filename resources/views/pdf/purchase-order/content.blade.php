        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="p-0 text-xs text-left text-black " style="text-transform: capitalize;" valing="top">
                        {{ $data['form_payment'] }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    @foreach ($data->provider->approval_chain == 'especial' ? $data->progress_special : $data->progress as $step)
                        <td style="border:none;width:100px;text-align: center;">
                            ...
                            @else
                                <p style="font-size: 11px;margin:0;font-weight: bold;color:#808080;">
                                    {{ $step['job-pdf'] }}</p>
                                ...
                                <p style="font-size: 11px;margin:0;color:#808080;">
                                    <span
                                        class="inline-flex items-center px-2 py-1 text-xs font-medium text-red-500 rounded-md bg-red-600/10 inset-ring inset-ring-red-400/20">Sin
                                        respuesta</span>
                                </p>
                            @endif
                        </td>
