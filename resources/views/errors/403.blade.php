...
<body>
    <main class="grid min-h-full px-6 py-24 bg-white place-items-center sm:py-32 lg:px-8">
        <div class="text-center">
            <p class="text-6xl font-semibold text-red-600">403</p>
            <h1 class="mt-4 text-5xl font-semibold tracking-tight text-gray-900 text-balance sm:text-7xl">El acceso a
                esta página está restringido.
            </h1>
