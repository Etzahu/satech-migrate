                                    ...
                                    <center>
                                        ...
                                        <table class="table table-borderless" border="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="font-size: 12px;font-family: 'Roboto';">Proveedor</td>
                                                    <td
                                                        style="font-size: 12px;font-family: 'Roboto';text-align: left;font-weight: bold;color: var(--dark);">
                                                        {{ $data['provider']['company_name'] }}</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';">Requisición
                                                    </td>
                                                    <td
                                                        style="font-size: 12px;font-family: 'Roboto';font-weight: bold;color: var(--dark);">
                                                ...
                                                <tr>
                                                    <td style="font-size: 12px;font-family: 'Roboto';">Comprador</td>
                                                    <td
                                                        style="font-size: 12px;font-family: 'Roboto';text-align: left;font-weight: bold;color: var(--dark);">
                                                        {{ $data['purchaser']['name'] }}
                                                    </td>
