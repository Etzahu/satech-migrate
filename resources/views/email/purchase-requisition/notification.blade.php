...
<body>
    <div style="background-color: #dae6f7">
                ...
                <tr>
                    ...
                    <td class="body-content" style="color: var(--dark); font-family: Roboto, sans-serif">
                        ...
                        <table class="container" width="100%" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                                <tr>
                                    <td class="container-content" style="
                        border-radius: 10px;
                      ...
                      ">
                            ...
                            class="img-fluid"
                            src="assets/img/logotipo_GPT.png"
                            style="width: 342px"
                            width="342" /><!
                        [endif]--><!--[if !mso
                        ]><!--><img class="img-fluid" src="{{ asset('assets/images/logo/logotipo_GPT.png') }}"
                          ...
                          Requisición de compra
                                            ...
                                            <table class="layout-table" role="presentation" cellpadding="0"
                                                cellspacing="0" style="width: 100%; border-bottom: 2px solid #dee2e6">
                                                <tbody>
                                                    <tr>
                                ...
                                ">
                                            ...
                                            <h4 style="color: #162d4d">Hola, {{ $data['user']['nombre'] }}</h4>
                                            <p style="color: #5b6c82">
                                                {{ $data['status'] }}
                                            </p>
                                            <table class="spacer" role="presentation" border="0" cellpadding="0"
                                ...
                                información de la requisición
                                                ...
                                                <tbody>
                                                    @foreach ($data['solicitud'] as $key => $item)
                                                    <tr>
                                                        <td style="
                                  font-size: #162d4d;
                                  font-family: Roboto, sans-serif;
                                ...
                                ">
                                                ...
                                                <tbody>
                                                    @foreach ($data['partidas'] as $key => $itemPart)
                                                    <tr>
                                                        <th style="
                                                        font-size: #162d4d;
                                  font-family: Roboto, sans-serif;
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="btn-content">
                                                            <a href="javascript:void(0)" style="text-transform: uppercase;"><strong>ver solicitud</strong></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
