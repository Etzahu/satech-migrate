...
<head>
    ...
    <!--<![endif]-->
	<!--[if !mso]><!-->
	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:400,500,500i,700,700i,900&amp;display=swap">
    <!--<![endif]-->
</head>
...
<body style="background-color: #dae6f7;">
    <table role="presentation" cellspacing="0" cellpadding="0" width="100%" style="background-color: #dae6f7;">
        <tbody>
            <tr><!--[if mso]>
 <td></td> <![endif]--><td class="body-content" style="color: var(--dark);font-family: Roboto, sans-serif;">
                    <table class="spacer" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;height: 30px;">
                        <tbody>
                            <tr>
                    ...
                    <table class="container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                        <tbody>
                            <tr>
                                <td class="container-content" style="border-radius: 10px;background-color: #ffffff;padding-top: 30px;padding-right: 30px;padding-bottom: 30px;padding-left: 30px;border-width: 1px;border-color: var(--gray-light);">
                                    <center><!--[if mso]><img class="img-fluid" src="{{ asset('images/watermark.jpg') }}" style="width: 174px;" width="174"><![endif]--><!--[if !mso]><!--><img class="img-fluid" src="{{ asset('images/watermark.jpg') }}" style="width: 174px;"><!--<![endif]-->
                                        <table class="spacer" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;height: 20px;">
                                            <tbody>
                                                <tr>
                                        ...
                                        <h1 style="background-color: #ffffff;font-size: 18px;font-family: Roboto, sans-serif;color: #162d4d;text-transform: uppercase;">Requisición de compra</h1>
                                        <table class="spacer" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;height: 20px;">
                                            <tbody>
                                                <tr>
                                                    <td width="100%" height="20"></td>
                                        ...
                                        <table class="table table-borderless" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-size: 12px;font-family: 'Roboto';width: 48.906px;" width="48.906">Compañía</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';text-align: left;font-weight: bold;color: var(--dark);">{{ $data['company'] }}</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';width: 110.062px;" width="110.062">No. de requisición</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';font-weight: bold;color: var(--dark);">{{ $data['folio'] }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 12px;font-family: 'Roboto';">Gerencia</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';text-align: left;font-weight: bold;color: var(--dark);">{{ $data['management'] }}</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';">Fecha solicitada</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';font-weight: bold;color: var(--dark);">{{ $data['created_at'] }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 12px;font-family: 'Roboto';">Proyecto</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';font-weight: bold;color: var(--dark);">{{ $data['project'] }}</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';">Fecha requerida</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';font-weight: bold;color: var(--dark);">{{ $data['date_delivery'] }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 12px;font-family: 'Roboto';">Solicitante</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';text-align: left;font-weight: bold;color: var(--dark);">{{ $data['requester'] }}</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';">Lugar de entrega</td>
                                                    <td style="font-size: 12px;font-family: 'Roboto';font-weight: bold;color: var(--dark);">{{ $data['delivery_address'] }}</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px;">
                                            <thead>
                                                <tr>
                                                    <th colspan="4" style="color: #162d4d;font-weight: bold;font-size: 14px;">PARTIDAS</th>
                                                </tr>
                                                <tr>
                                                    <td class="text-center" style="font-size: 12px;font-family: Roboto, sans-serif;font-weight: bold;color: var(--dark);width: 27.609px;" width="27.609">Código</td>
                                                    <td class="text-center" style="font-size: 12px;font-family: Roboto, sans-serif;font-weight: bold;color: var(--dark);">Producto/Servicio</td>
                                                    <td class="text-center" style="font-family: Roboto, sans-serif;color: var(--dark);font-size: 12px;padding: 12px;font-weight: bold;width: 74.406px;padding: 5px;margin: 0;" width="74.406">Unidad</td>
                                                    <td class="text-center" style="font-family: Roboto, sans-serif;color: var(--dark);font-size: 12px;font-weight: bold;width: 56.047px;" width="56.047">Cantidad</td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($data['items'] as $item)
                                                <tr>
                                                    <td style="font-size: 12px;font-family: Roboto, sans-serif;">{{ $item['code'] }}</td>
                                                    <td style="font-size: 12px;font-family: Roboto, sans-serif;">{{ $item['product'] }}</td>
                                                    <td style="font-size: 12px;font-family: Roboto, sans-serif;">{{ $item['um'] }}</td>
                                                    <td style="font-size: 12px;font-family: Roboto, sans-serif;">{{ $item['quantity'] }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        <table class="table table-bordered" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px;">
                                            <thead>
                                                <tr>
                                                    <th colspan="4" style="color: #162d4d;font-weight: bold;font-size: 14px;text-transform: uppercase;">Observaciones de las partidas</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($data['items'] as $item)
                                                <tr>
                                                    <td style="font-size: 12px;font-family: Roboto, sans-serif;width: 68.547px;font-weight: bold;color: var(--dark);" width="68.547">Partida {{ $loop->iteration }}</td>
                                                    <td style="font-size: 12px;font-family: Roboto, sans-serif;">{{ $item['observation'] }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table table-bordered" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px;">
                                            <thead>
                                                <tr>
                                                    <th colspan="2" style="color: #162d4d;font-weight: bold;font-size: 14px;">OBSERVACIONES O NOTAS</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="font-family: Roboto, sans-serif;color: #5b6c82;">
                                                        <p class="text-justify" style="font-size: 12px;">{{ $data['observation'] }}</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <center><small style="color: var(--dark);font-size: 12px;"> Notificación generada automáticamente</small></center>
                    <table class="spacer" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;height: 30px;">
                        <tbody>
                            <tr>
                                <td width="100%" height="30"></td>
