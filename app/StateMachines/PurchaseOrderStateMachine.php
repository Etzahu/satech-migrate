...
class PurchaseOrderStateMachine extends StateMachine
{
    ...
    public function transitions(): array
    {
        return [
            ...
            'aprobado por gerente solicitante' => ['aprobada para emisión','aprobado por DG nivel 1', 'devuelto por DG nivel 1', 'cancelado por DG nivel 1'],
            'aprobado por DG nivel 1' =>  ['devuelto por DG nivel 2', 'cancelado por DG nivel 2', 'aprobada para emisión'],
