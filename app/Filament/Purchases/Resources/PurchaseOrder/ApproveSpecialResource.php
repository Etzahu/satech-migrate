...
use App\Filament\Purchases\Resources\PurchaseOrder\ApproveSpecialResource\Pages;


class ApproveSpecialResource extends Resource
{
  protected static ?string $model = PurchaseOrder::class;
  protected static ?string $modelLabel = 'Orden';
  protected static ?string $pluralModelLabel = 'Orden';
  protected static ?string $navigationLabel = 'Aprobar especial';
  protected static ?string $slug = 'ordenes/aprobar-especial';
  ...
  {
    return parent::getEloquentQuery()->approveSpecial();
  }
  public static function getNavigationBadge(): ?string
  {
    return static::getModel()::approveSpecial()->count();
  }
