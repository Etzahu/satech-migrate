        ...
        return [
            ...
            'nodes' => [
                ...
                [
                    ...
                    'col' => 2, 'row' => 1,
                    'actor' => 'Gerente solicitante / Gerencia de Ingeniería y Mantenimiento',
                    'description' => 'El gerente de compras aprobó. La orden espera la aprobación del nivel 2. En Mantenimiento Especializado, Ingeniería, Soldadura, Manufactura y Servicios Técnicos ese nivel lo resuelve el rol —Gerencia de Ingeniería y Mantenimiento— y no la cadena; en el resto de la empresa lo resuelve el gerente del área solicitante según la cadena de la requisición.',
                    'notify' => 'Correo a quien aprueba en el nivel 2',
                ],
                [
                    'id' => 'apr_gsolicitante', 'label' => 'Aprobado por gte. solicitante', 'icon' => '✔️', 'type' => 'approval',
                    'col' => 3, 'row' => 1,
                    'actor' => 'Dirección General (nivel 1)',
                    'description' => 'El nivel 2 aprobó. La orden espera la autorización de Dirección General nivel 1: en los cinco departamentos operativos la resuelve el rol y en el resto de la empresa la cadena de la requisición.',
                    'notify' => 'Correo a quien autoriza en el nivel 3',
                ],
                [
                    'id' => 'apr_dg1', 'label' => 'Aprobado por DG nivel 1', 'icon' => '🏛️', 'type' => 'approval',
                    'col' => 4, 'row' => 1,
                    'actor' => 'Dirección Administrativa',
                    'description' => 'DG nivel 1 autorizó. La orden espera la liberación de Dirección Administrativa, que es obligatoria en todo momento y aplica a toda la empresa.',
                    'notify' => 'Correo a quien libera (Dirección Administrativa)',
                ],
                [
                ...
                // ── Cancelaciones (estados finales) ──────────────────────────
                [
                    'id' => 'dev_liberacion', 'label' => 'Devuelto por liberación', 'icon' => '↩️', 'type' => 'return',
                    'col' => 4, 'row' => 2,
                    'actor' => 'Comprador',
                    'description' => 'Dirección Administrativa devolvió la orden con observaciones. El comprador la corrige y la reenvía al flujo.',
                    'notify' => 'Correo al comprador',
                ],
                [
                    'id' => 'can_liberacion', 'label' => 'Cancelado por liberación', 'icon' => '⛔', 'type' => 'cancel',
                    'col' => 4.5, 'row' => 3,
                    'actor' => '—',
                    'description' => 'Dirección Administrativa canceló definitivamente la orden. Estado final.',
                    'notify' => 'Correo al comprador',
                ],
                [
            ...
            'edges' => [
                ...
                ['from' => 'apr_dg1', 'to' => 'liberada', 'label' => 'Libera', 'type' => 'forward', 'main' => true],
                ['from' => 'liberada', 'to' => 'apr_dg2', 'label' => 'Supera límite', 'type' => 'forward', 'main' => true],
                ['from' => 'apr_dg2', 'to' => 'autorizada', 'label' => 'Autoriza', 'type' => 'forward', 'main' => true],
                ['from' => 'liberada', 'to' => 'autorizada', 'label' => 'En límite', 'type' => 'forward', 'arc' => -95],
                ...
                ['from' => 'apr_dg1', 'to' => 'dev_liberacion', 'label' => 'Devuelve', 'type' => 'return'],
                ['from' => 'liberada', 'to' => 'dev_dg2', 'label' => 'Devuelve', 'type' => 'return'],
                ...
                ['from' => 'apr_dg1', 'to' => 'can_liberacion', 'label' => 'Cancela', 'type' => 'cancelGap'],
                ['from' => 'liberada', 'to' => 'can_dg2', 'label' => 'Cancela', 'type' => 'cancelGap'],
                // Reingreso al flujo
                ...
                ['from' => 'dev_liberacion', 'to' => 'rev_gcompras', 'type' => 'bus'],
